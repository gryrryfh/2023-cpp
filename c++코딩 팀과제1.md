...
## 소감
* 이재경
* 추승범 : 이번 팀 프로젝트는 새로 배우는 내용이 많아서 다소 어려움 점이 있었습니다. 하지만 새로운 내용도 계속 반복 학습하는 CRect 클래스를 접목하여 학습해서 좀 더 빠르고 쉽게 익힐 수 있었습니다. 교수님 덕분에 이렇게 하나의 예시에 살을 붙여나가는 공부 방법이 효과가 좋다는 것을 체감했습니다. 아직 STL부분이 잘 이해가 되지 않지만 더 열심히 공부해서 완벽하게 이해할 수 있도록 노력하겠습니다.
